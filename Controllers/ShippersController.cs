...
namespace NorthwindMVC.Controllers
{
    public class ShippersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RegionID,ShipperID,CompanyName,Phone")] Shippers shippers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RegionID,ShipperID,CompanyName,Phone")] Shippers shippers)
        {
            if (ModelState.IsValid)
            {
